...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaLogs/releases/download/v1.36.0/victoria-logs-linux-amd64-v1.36.0.tar.gz
tar xzf victoria-logs-linux-amd64-v1.36.0.tar.gz
...
docker run --rm -it -p 9428:9428 -v ./victoria-logs-data:/victoria-logs-data \
  docker.io/victoriametrics/victoria-logs:v1.36.0 -storageDataPath=victoria-logs-data
```
