...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaLogs/releases/download/v1.37.2/vlutils-linux-amd64-v1.37.2.tar.gz
tar xzf vlutils-linux-amd64-v1.37.2.tar.gz
./vlogscli-prod
```
